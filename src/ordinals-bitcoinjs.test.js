...
describe('bitcoin inscriptions using bitcoinjs', () => {
  ...
  test('createCommitTxData of Hello!!', () => {
    ...
    expect(commitTxData).toEqual({
      cblock:
        'c1d734e09fc6ed105225ff316c6fa74f89096f90a437b1c7001af6d0b244d6f151',
      script: [
        expect.toBeBuffer(
          'd734e09fc6ed105225ff316c6fa74f89096f90a437b1c7001af6d0b244d6f151'
        ),
      ...
      tapleaf:
        '13caa908fa38108fa21fcc47e99764ed5da8e579aed0a5af2c50c02257efeee9',
      tpubkey:
        'a56d17d8e7c732e3721c21b1df3a0643c0e4260efb524d01bb0cce1ff4ca0766',
      revealAddress:
        'bc1p54k30k88cuewxusuyxca7wsxg0qwgfswldfy6qdmpn8plax2qanq9wtlsw',
  ...
  test('createRevealTx of Hello!!', async () => {
    ...
    const rawTxWithoutSignature = revelRawTx.rawTx.replace(
      revelRawTx.signature,
      '<SIGNATURE>'
    );
    ...
    expect(revelRawTx).toEqual({
      ...
      inscriptionId:
        'e79beb0fe7d1aaa6a1ffd589ad95f52c54b1137b9c6620f0fcc56631db8f020ci0',
